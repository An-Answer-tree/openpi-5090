...
def _make_pi05_libero_acpd_v2_config(
    ...
    *,
    ...
    if dynamic_view_gate:
        name = f"pi05_libero_backview_acpd_v2_layer{layer}_dynamic_gate_lora"
    elif not injection:
...
_CONFIGS = [
    ...
    _make_pi05_libero_acpd_v2_config(layer=10, dynamic_view_gate=True),
