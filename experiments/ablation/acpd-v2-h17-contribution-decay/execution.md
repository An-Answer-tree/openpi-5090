...
| 15K中间点全量验证 | 136119_[0-3] | Spatial/Object完成后按用户要求停止 | 共完成1000回合，无四套pooled；见analysis-15k.md |
| 15K结果汇总 | 136120 | 已取消 | 不产生不完整的四套汇总 |
| 15K配对分析 | 136123 | 已取消 | 已完成两套的探索性分析见analysis-15k.md |
