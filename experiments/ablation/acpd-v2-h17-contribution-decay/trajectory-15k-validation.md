...
- 评测：LIBERO spatial、object、goal、libero_10；每个 suite 有 10 个任务，
  `num_trials_per_task=50`，因此各 500 回合，共 2000 回合。
...
- 输出：`/opt/liutong/openpi-5090-evals/acpd-v2-h17-contribution-decay/14999-corrected/`
