...
| H9-scale-b BS64 30K，最终 hidden 注入 | 129728 | 运行中，约 step 18,800 | 5K checkpoint 为 `23.15%`；不同样本预算，不与 H9 作 batch 因果比较。 |
| H11 BS64 smoke，同层注入 | 129807 | 完成 | 运行门槛通过。 |
| H11 BS64 30K，同层注入 | 129808 | 运行中，约 step 8,090 | 4999 checkpoint 已生成，尚无任务成功率结论。 |
| H12 backview SFT BS64 5K | 130285 | 运行中，约 step 3,580 | 与 H9-scale-b 匹配的无蒸馏 baseline；尚无结论。 |
