...
| H9-scale-b BS64 30K，最终 hidden 注入 | 129728 | 运行中，约 step 20,300 | 5K checkpoint 为 `23.15%`；不同样本预算，不与 H9 作 batch 因果比较。 |
| H11 BS64 smoke，同层注入 | 129807 | 完成 | 运行门槛通过。 |
| H11 BS64 30K，同层注入 | 129808/130490 | 训练和验证运行中 | 训练约 step 9,000；四套验证均已进入 episode，尚无最终任务成功率结论。 |
| H12 backview SFT BS64 5K | 130285/130491 | 训练完成，验证排队 | step 4900 loss `0.0290`；验证等待资源，尚无成功率结论。 |
