...
| SFT 35K 与自身30K比较 | `57.15%` 对 `60.45%`；配对差值 `-3.30` 点，95% CI `[-5.75, -0.85]` | 本次续训到35K后成功率下降；40K/50K/60K尚待验证。 |
...
因此尚未证明H9提高最终上限。H9 40K相对35K的下降区间跨0；20K仍在验证。
H9续训在45K checkpoint完整后按用户决定停止，SFT已续训到60K，后期验证排队。
