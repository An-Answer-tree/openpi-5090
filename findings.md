...
| H9-scale-b BS64 30K，最终 hidden 注入 | 129728 | 运行中，约 step 22,700 | 5K checkpoint 为 `23.15%`；不同样本预算，不与 H9 作 batch 因果比较。 |
...
| H13 loss-only BS64 5K | 130599/130600 | 训练约 step 1,000，验证依赖训练 | 保留 contribution loss 和 ACL，只关闭训练与推理注入；尚无结论。 |
